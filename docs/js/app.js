...
/* harmony export */ });
/* harmony import */ var masonry_layout_masonry_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! masonry-layout/masonry.js */ "./node_modules/masonry-layout/masonry.js");
/* harmony import */ var _VideoGrid_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./VideoGrid.js */ "./src/js/VideoGrid.js");
/* harmony import */ var _ResizePreviews_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ResizePreviews.js */ "./src/js/ResizePreviews.js");
...
var Gallery = /*#__PURE__*/function () {
  ...
  _createClass(Gallery, [{
    ...
    key: "activateImageBox",
    value: function activateImageBox() {
      document.querySelector(this.selector).classList.add('image-box-active');
    }
  }, {
    key: "activateVideoGrid",
    value: function activateVideoGrid() {
      new _VideoGrid_js__WEBPACK_IMPORTED_MODULE_1__["default"](this.itemSelector).attach();
    }
  }, {
    key: "resizePreviews",
    value: function resizePreviews() {
      new _ResizePreviews_js__WEBPACK_IMPORTED_MODULE_2__["default"](this.previews).attach();
    }
  }, {
    key: "activateMasonry",
    value: function activateMasonry() {
      new masonry_layout_masonry_js__WEBPACK_IMPORTED_MODULE_0__(this.selector, this.masonry);
    }
  }, {
    key: "isTouchDevice",
...
/***/ "./src/js/Generators/Hydrators/FormatHydrator.js":
/*!*******************************************************!*\
  !*** ./src/js/Generators/Hydrators/FormatHydrator.js ***!
  \*******************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _Hydrator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Hydrator.js */ "./src/js/Generators/Hydrators/Hydrator.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
...
}(_Hydrator_js__WEBPACK_IMPORTED_MODULE_0__["default"]);
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (FormatHydrator);

/***/ }),

/***/ "./src/js/Generators/Hydrators/Hydrator.js":
/*!*************************************************!*\
  !*** ./src/js/Generators/Hydrators/Hydrator.js ***!
  \*************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _Generators_Hydrators_FormatHydrator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Generators/Hydrators/FormatHydrator.js */ "./src/js/Generators/Hydrators/FormatHydrator.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
var ResizePreviews = /*#__PURE__*/function () {
  function ResizePreviews(options) {
    _classCallCheck(this, ResizePreviews);
  ...
  _createClass(ResizePreviews, [{
    key: "attach",
    value: function attach() {
      this.customizeCssClasses(this.hydrateFormats(this.getItems()));
    }
  }, {
    key: "getItems",
    value: function getItems() {
      var nodes = document.querySelectorAll(this.options.itemSelector);
      return _toConsumableArray(nodes).map(function (item) {
        return {
          node: item
        };
      });
    ...
    key: "hydrateFormats",
    value: function hydrateFormats(items) {
      return new _Generators_Hydrators_FormatHydrator_js__WEBPACK_IMPORTED_MODULE_0__["default"](this.options.formats).hydrateAll(items);
    }
  }, {
    key: "customizeCssClasses",
    value: function customizeCssClasses(items) {
      var _this = this;
      items.forEach(function (item) {
        var classList = item.node.classList;
        if (!classList.contains(_this.cssClasses.base)) {
          classList.add(_this.cssClasses.base);
        }
        if (classList.contains(_this.cssClasses["default"])) {
          classList.replace(_this.cssClasses["default"], _this.cssClasses.prefix + item.format);
        } else {
          classList.add(_this.cssClasses.prefix + item.format);
        }
      });
      return items;
    }
  }]);
  return ResizePreviews;
}();
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ResizePreviews);
...
new _Gallery_js__WEBPACK_IMPORTED_MODULE_0__["default"]({
